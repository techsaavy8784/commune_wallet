...
import icon_commune from '~assets/images/icon-512.png';
import { decodeTokenId } from '@earthwallet/assets';
import NFT_COMMUNE_DAY from '~assets/images/communeday_nft.png';
...
export const ICP_NFT_LIST = [
  ...
  },
  {
    ...
    isAirdrop: false,
    description:
      'Commune Art - Commune NFTs. Create, earn, and collect digital assets and NFTs that let you monetize the value you contribute. ',
    icon: icon_commune,
    order: 1,
  },
];
...
export const getCommuneArtCollectionIcon = (collectionId: string) =>
...
export const getAirDropNFTInfo = () => ({
  ...
  isLive: false,
  isAirdrop: false,
  name: 'Commune Day 2022', //can be changed
  //can be changed
  description:
    'Happy Commune Day! Something new is coming to Commune and this NFT gets you early access...',
  icon: NFT_COMMUNE_DAY, //can be changed
  claimedTxt:
    'Congratulations! Your Commune Day NFT is registered and will be sent to account ',
  //can be changed
