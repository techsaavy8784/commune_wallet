const es = {
  ...
  walletSettings: {
    ...
    checkbox:
      'Use Commune Wallet como su proveedor predeterminado de billetera Web3',
  ...
  swap: {
    info: 'Commune DEX te permite intercambiar tus tokens sin intermediarios centrales. Las tarifas se utilizan para compensar las emisiones.',
