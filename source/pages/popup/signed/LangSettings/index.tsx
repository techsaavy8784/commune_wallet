...
const LangSettings = () => {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.myAc}>Language Setting</div>
      <div className={styles.container}>
        ...
        >
          {Object.keys(i18n.translations)
            .sort((a, b) =>
              translationsLabels[
                a as keyof typeof translationsLabels
              ].localeCompare(
                translationsLabels[b as keyof typeof translationsLabels]
              )
            )
                ...
                <div className={styles.checkboxContent}>
                  <div>
                    <div className={styles.checkboxTitle}>
                      {translationsLabels[
                        lang as keyof typeof translationsLabels
                      ] || lang.toLocaleUpperCase()}
                    </div>
                  </div>
                </div>
                {lang == i18n.locale && (
                  <img className={styles.checkboxIcon} src={ICON_CHECKED} />
                )}
              </div>
            ))}
        </div>
